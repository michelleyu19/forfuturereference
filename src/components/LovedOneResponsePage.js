...
import { LovedOneQuestionList } from './Text';
import RESPONSE_TYPES from '../constants/ResponseTypes';
import './ResponsePageStyles.scss';
import * as db from '../actions/index';

class LovedOneResponsePage extends Component {
  constructor(props) {
    super(props);
    const questions = LovedOneQuestionList.map((item) => ({
    ...
    return (
      <div id="selfResponsePageWhole">
        ...
        <div className="response-page">
          <div>Write a note to your loved one! Choose from our prompts or write your own message:</div>
...
export default LovedOneResponsePage;
